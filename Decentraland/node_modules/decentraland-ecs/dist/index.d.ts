 ...
 * @public
 */
declare class PointerEvent_2<GlobalInputEventResult> {
...
export declare interface Ray {
    origin: ReadOnlyVector3_2;
    direction: ReadOnlyVector3_2;
    distance: number;
}
...
export declare interface RaycastHit {
    didHit: boolean;
    ray: Ray;
    hitPoint: ReadOnlyVector3_2;
    hitNormal: ReadOnlyVector3_2;
}
...
export { ReadOnlyQuaternion_2 as ReadOnlyQuaternion }
...
export { ReadOnlyVector2_2 as ReadOnlyVector2 }
...
export { ReadOnlyVector3_2 as ReadOnlyVector3 }
...
export { ReadOnlyVector4_2 as ReadOnlyVector4 }
