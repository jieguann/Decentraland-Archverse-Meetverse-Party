        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, setupUtils_1.ensureWriteFile(path.resolve(explorePath, 'realms'), JSON.stringify([
                            {
                ...
                case 2:
                    // 3) Copy and write files
                    _e.sent();
                    return [4 /*yield*/, setupUtils_1.ensureWriteFile(path.resolve(contractsPath, 'servers'), JSON.stringify([
                            {
                ...
                case 3:
                    _e.sent();
                    return [4 /*yield*/, setupUtils_1.ensureWriteFile(path.resolve(contractsPath, 'pois'), '')];
                case 4:
                    _e.sent();
                    return [4 /*yield*/, setupUtils_1.ensureWriteFile(path.resolve(sceneContentPath, 'scene'), JSON.stringify(setupUtils_1.getSceneJson({
                            baseFolders: [workDir],
                ...
                case 5:
                    _e.sent();
                    return [4 /*yield*/, setupUtils_1.ensureWriteFile(path.resolve(lambdasPath, 'profiles'), JSON.stringify([]))];
                case 6:
                    _e.sent();
                    ignoreFileContent = '';
                    ...
                    contentStatic = setupUtils_1.entityV3FromFolder({
                        folder: workDir,
                ...
                case 7:
                    ...
                    return [4 /*yield*/, setupUtils_1.ensureCopyFile(path.resolve(workDir, $.original_path), path.resolve(contentsContentPath, $.hash))];
                case 8:
                    _e.sent();
                    _e.label = 9;
                case 9:
                ...
                case 10: return [4 /*yield*/, Promise.all([
                        // copy project
                        setupUtils_1.ensureWriteFile(path.resolve(exportDir, 'index.html'), finalContent),
                        setupUtils_1.ensureCopyFile(path.resolve(dclKernelPath, 'index.js'), path.resolve(exportDir, 'index.js')),
                        setupUtils_1.ensureCopyFile(path.resolve(dclKernelPath, 'favicon.ico'), path.resolve(exportDir, 'favicon.ico')),
                        // copy dependencies
                        setupUtils_1.copyDir(dclUnityRenderer, path.resolve(exportDir, 'unity-renderer')),
                        setupUtils_1.copyDir(dclKernelDefaultProfilePath, path.resolve(exportDir, 'default-profile')),
                        setupUtils_1.copyDir(dclKernelLoaderPath, path.resolve(exportDir, 'loader'))
                    ])];
                case 11:
                    _e.sent();
                    if (!fs.existsSync(dclKernelImagesDecentralandConnectPath)) return [3 /*break*/, 13];
                    return [4 /*yield*/, setupUtils_1.copyDir(dclKernelImagesDecentralandConnectPath, path.resolve(exportDir, 'images', 'decentraland-connect'))];
                case 12:
                    _e.sent();
                    _e.label = 13;
                case 13:
                ...
                case 14:
                    ...
                    return [4 /*yield*/, setupUtils_1.ensureCopyFile(path.resolve(exportDir, 'unity-renderer', fileName), path.resolve(exportDir, 'unity-renderer', fileName + ".br"))];
                case 15:
                    _e.sent();
                    _e.label = 16;
                case 16:
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, setupUtils_1.ensureWriteFile(wearableResponsePath, '')];
                case 1:
                    _c.sent();
                    return [4 /*yield*/, setupUtils_1.downloadFile(baseAvatarUrl, wearableResponsePath)];
                case 2:
                    _c.sent();
                ...
                case 3:
                    ...
                    return [4 /*yield*/, setupUtils_1.ensureWriteFile(filePath, '')];
                case 4:
                    _c.sent();
                    promises.push(setupUtils_1.downloadFile(url.toString(), filePath));
                    _c.label = 5;
                case 5:
                    _i++;
                    return [3 /*break*/, 3];
                ...
                case 7:
                    _c.sent();
                    return [4 /*yield*/, setupUtils_1.ensureWriteFile(wearableResponsePath, JSON.stringify(response, null, 2))];
                case 8:
                    _c.sent();
                    return [2 /*return*/];
            }
